class Strings {
  ...
  static String pleaseInputEmail = "please input email";
  static String pleaseInputPassword = "please input password";
  static String passwordNotMath = "Password not math";
